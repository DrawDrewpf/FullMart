...
exports.setDatabasePool = void 0;
 ...
 */
router.post('/', auth_1.authenticateToken, (0, validation_1.validateBody)(schemas_1.createOrderSchema), async (req, res) => {
    ...
    `;
        const orderValues = [
            ...
            types_1.PaymentStatus.COMPLETED // Simulated payment
        ];
